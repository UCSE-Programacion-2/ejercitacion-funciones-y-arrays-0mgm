...
function unirConSeparador(elementos, separador) {
  ...
  // Tu código:
  let resultado = elementos.join(separador);
  return resultado;
}
...
function indiceUltimo(arreglo, item) {
  // `.lastIndexOf`
  // Tu código:
  let indice = arreglo.lastIndexOf(item);
  return indice;
}
...
function existeConIncludes(arreglo, item) {
  // `.includes`
  // Tu código:
  let existe = arreglo.includes(item);
  return existe;
}
...
function subArregloCopia(origen, inicio, fin) {
  ...
  // Tu código:
  let copia = origen.slice(inicio, fin);
  return copia;
}
...
function pegarDosArreglos(arregloA, arregloB) {
  ...
  // Tu código:
  let resultado = arregloA.concat(arregloB);
  return resultado;
}
...
function sumatorioConReduce(numeros, inicial = 0) {
  ...
  // Tu código:
  let resultado = numeros.reduce((acumulador, actual) => acumulador + actual, inicial);
  return resultado;
}
...
function agruparPorCampoReduce(listaObjetos, nombreCampo) {
  ...
  // Tu código:
  let resultado = listaObjetos.reduce((acumulador, item) => {
    let clave = item[nombreCampo];
    if (acumulador[clave] === undefined) {
      acumulador[clave] = [];
    }
...
function agruparPorCampoObjectGroupBy(listaObjetos, nombreCampo) {
  ...
  // Tu código:
  let resultado = Object.groupBy(listaObjetos, (item) => item[nombreCampo]);
  return resultado;
}
...
function objetoNombreMayuscConFlechaAnidada(nombre) {
  ...
  let objeto = {
    ...
    enMayuscMedianteFlecha: function () {
      let convertir = () => this.nombre.toUpperCase();
      return convertir();
    }
  };
  return objeto;
